...
<div class="space-y-4 sm:space-y-8 pb-20">
      ...
      <div class="flex items-center justify-end gap-2 px-3 pt-4 sm:pt-2 sm:px-4 animate-fade-in">
        ...
        <a href="https://lin.ee/3rHhZWz" target="_blank" class="flex items-center gap-1.5 px-3 py-1.5 sm:px-4 sm:py-2 bg-white text-[#00B900] border border-[#00B900] rounded-full font-bold text-[10px] sm:text-xs hover:bg-[#00B900] hover:text-white transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-0.5 text-decoration-none">
