      ...
      <div class="space-y-8 text-gray-600 leading-relaxed">
        ...
        <section>
          ...
          <ul class="list-disc pl-5 space-y-2">
            <li>當您註冊會員、使用購物車結帳或使用客服聯絡等功能時，我們將視服務性質，請您提供必要的個人資料（包含但不限於：**姓名、聯絡電話、電子郵件、收件地址**等），並在該特定目的範圍內處理及利用。</li>
        ...
        <section>
          ...
          <ul class="list-disc pl-5 space-y-2 mt-2">
            <li>**為完成交易與提供服務之必要：** 我們必須將您的姓名、聯絡電話、收件地址等相關必要資訊，提供給**合作之物流業者（如 7-11 賣貨便、全家、宅配公司等）及第三方金流服務機構**，以利完成商品配送與款項收付。</li>
            <li>經由您書面或系統操作同意。</li>
        ...
        <section>
          ...
          <ul class="list-disc pl-5 space-y-2 mt-2">
            ...
            <li>請求停止蒐集、處理或利用，以及**請求刪除帳號與個人資料**。</li>
          </ul>
